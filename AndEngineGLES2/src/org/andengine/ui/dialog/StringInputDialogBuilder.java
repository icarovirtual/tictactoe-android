...
public class StringInputDialogBuilder extends GenericInputDialogBuilder<String> {
	...
	public StringInputDialogBuilder(final Context pContext, final int pTitleResID, final int pMessageResID, final int pErrorResID,
			final int pIconResID, final Callback<String> pSuccessCallback, final OnCancelListener pOnCancelListener) {
		super(pContext, pTitleResID, pMessageResID, pErrorResID, pIconResID, pSuccessCallback, pOnCancelListener);
	}

	public StringInputDialogBuilder(final Context pContext, final int pTitleResID, final int pMessageResID, final int pErrorResID,
			final int pIconResID, final String pDefaultText, final Callback<String> pSuccessCallback,
			final OnCancelListener pOnCancelListener) {
