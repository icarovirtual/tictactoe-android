...
public class GLMatrixStack {
	...
	public void glPushMatrix() throws GLMatrixStackOverflowException {
		...
		System.arraycopy(this.mMatrixStack, this.mMatrixStackOffset, this.mMatrixStack, this.mMatrixStackOffset
				+ GLMatrixStack.GLMATRIX_SIZE, GLMatrixStack.GLMATRIX_SIZE);
