...
public class PositionTextureCoordinatesUniformColorShaderProgram extends ShaderProgram {
	...
	public static final String FRAGMENTSHADER = "precision lowp float;\n" + "uniform sampler2D " + ShaderProgramConstants.UNIFORM_TEXTURE_0
			...
			+ ShaderProgramConstants.VARYING_TEXTURECOORDINATES + ";\n" + "void main() {\n" + "	gl_FragColor = "
			+ ShaderProgramConstants.UNIFORM_COLOR + " * texture2D(" + ShaderProgramConstants.UNIFORM_TEXTURE_0 + ", "
			+ ShaderProgramConstants.VARYING_TEXTURECOORDINATES + ");\n" + "}";
	...
	private PositionTextureCoordinatesUniformColorShaderProgram() {
		super(PositionTextureCoordinatesUniformColorShaderProgram.VERTEXSHADER,
				PositionTextureCoordinatesUniformColorShaderProgram.FRAGMENTSHADER);
	}
	...
	protected void link(final GLState pGLState) throws ShaderProgramLinkException {
		...
		PositionTextureCoordinatesUniformColorShaderProgram.sUniformModelViewPositionMatrixLocation = this
				.getUniformLocation(ShaderProgramConstants.UNIFORM_MODELVIEWPROJECTIONMATRIX);
		PositionTextureCoordinatesUniformColorShaderProgram.sUniformTexture0Location = this
	...
	public void bind(final GLState pGLState, final VertexBufferObjectAttributes pVertexBufferObjectAttributes) {
		...
		GLES20.glUniformMatrix4fv(PositionTextureCoordinatesUniformColorShaderProgram.sUniformModelViewPositionMatrixLocation, 1, false,
