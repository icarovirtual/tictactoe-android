...
/**
 * TODO if(!SystemUtils.isAndroidVersionOrHigher(Build.VERSION_CODES.FROYO)) -->
...
public abstract class ETC1Texture extends Texture {
	...
	public ETC1Texture(final TextureManager pTextureManager, final TextureOptions pTextureOptions,
