...
public interface IBuildableTextureAtlas<S extends ITextureAtlasSource, T extends ITextureAtlas<S>> extends ITextureAtlas<S> {
	 ...
	 * {@link ITextureAtlasSource} won't get built through this
	 * {@link BuildableTextureAtlas}.
	 * 
	 * @deprecated Use
	 *             {@link BuildableTextureAtlas#addTextureAtlasSource(ITextureAtlasSource)}
	 *             instead.
	 */
	@Override
	@Deprecated
	...
	/**
	 * When all {@link ITextureAtlasSource}s are added you have to call
	 * {@link BuildableBitmapTextureAtlas#build(ITextureAtlasBuilder)}.
	 * 
	...
	/**
	 * Removes a {@link ITextureAtlasSource} before
	 * {@link BuildableBitmapTextureAtlas#build(ITextureAtlasBuilder)} is
	 * called.
	 * 
	 ...
	 * 
	 * @param pTextureAtlasBuilder
	 *            the {@link ITextureAtlasBuilder} to use for building the
	 *            {@link ITextureAtlasSource} in this
	 *            {@link BuildableBitmapTextureAtlas}.
	 * @return itself for method chaining.
	 * @throws TextureAtlasBuilderException
	 *             i.e. when the {@link ITextureAtlasSource} didn't fit into
