...
/**
 * The {@link VertexBufferObjectAttributeFix} is a special (c) Zynga 2012
 * 
...
public class VertexBufferObjectAttributeFix extends VertexBufferObjectAttribute {
	...
	public VertexBufferObjectAttributeFix(final int pLocation, final String pName, final int pSize, final int pType,
			final boolean pNormalized, final int pOffset) {
