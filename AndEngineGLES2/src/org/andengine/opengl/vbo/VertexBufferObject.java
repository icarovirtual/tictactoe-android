...
/**
 * TODO Extract a common base class from {@link VertexBufferObject} and
 * {@link ZeroMemoryVertexBufferObject} (due to significant code duplication).
 * For naming, maybe be inspired by the java ByteBuffer naming (i.e.
 * HeapBackedFloatArrayVertexBufferObject, StreamBufferVertexBufferObject,
 * SharedBufferStreamVertexBufferObject).
 * 
...
public abstract class VertexBufferObject implements IVertexBufferObject {
	 ...
	 *            (Optional, if you manage reloading on your own.)
	 * @param pCapacity
	 * @param pDrawType
	 * @param pAutoDispose
	 *            when passing <code>true</code> this {@link VertexBufferObject}
	 *            loads itself to the active {@link VertexBufferObjectManager}.
	 *            <b><u>WARNING:</u></b> When passing <code>false</code> one
	 *            needs to take care of that by oneself!
	 * @param pVertexBufferObjectAttributes
	 *            to be automatically enabled on the {@link ShaderProgram} used
	 *            in {@link VertexBufferObject#bind(ShaderProgram)}.
	 */
	public VertexBufferObject(final VertexBufferObjectManager pVertexBufferObjectManager, final int pCapacity, final DrawType pDrawType,
			final boolean pAutoDispose, final VertexBufferObjectAttributes pVertexBufferObjectAttributes) {
