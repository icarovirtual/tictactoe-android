...
public class OrientationData extends BaseSensorData {
	...
	private void updateOrientation() {
		...
		// TODO Use dont't use identical matrixes in remapCoordinateSystem, due
		...
		case Surface.ROTATION_90:
			SensorManager.remapCoordinateSystem(this.mRotationMatrix, SensorManager.AXIS_Y, SensorManager.AXIS_MINUS_X,
					this.mRotationMatrix);
			break;
		// case Surface.ROTATION_180:
		// SensorManager.remapCoordinateSystem(this.mRotationMatrix,
		// SensorManager.AXIS_?, SensorManager.AXIS_?, this.mRotationMatrix);
		// break;
