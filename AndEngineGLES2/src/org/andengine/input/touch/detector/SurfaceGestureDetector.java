...
/**
 * @author rkpost (c) 2010 Nicolas Gramlich (c) 2011 Zynga Inc.
 * 
...
public abstract class SurfaceGestureDetector extends BaseDetector {
	...
	private class InnerOnGestureDetectorListener extends SimpleOnGestureListener {
		...
		@Override
		public boolean onFling(final MotionEvent pMotionEventStart, final MotionEvent pMotionEventEnd, final float pVelocityX,
