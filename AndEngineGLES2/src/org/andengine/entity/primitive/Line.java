...
public class Line extends Shape {
	...
	/**
	 * Uses a default {@link HighPerformanceLineVertexBufferObject} in
	 * {@link DrawType#STATIC} with the {@link VertexBufferObjectAttribute}s:
	 * {@link Line#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	...
	/**
	 * Uses a default {@link HighPerformanceLineVertexBufferObject} with the
	...
	public Line(final float pX1, final float pY1, final float pX2, final float pY2, final float pLineWidth,
			final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX1, pY1, pX2, pY2, pLineWidth, new HighPerformanceLineVertexBufferObject(pVertexBufferObjectManager, Line.LINE_SIZE,
				pDrawType, true, Line.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	public boolean collidesWith(final IShape pOtherShape) {
		if (pOtherShape instanceof Line) {
			...
			return LineCollisionChecker.checkLineCollision(this.mX, this.mY, this.mX2, this.mY2, otherLine.mX, otherLine.mY, otherLine.mX2,
					otherLine.mY2);
