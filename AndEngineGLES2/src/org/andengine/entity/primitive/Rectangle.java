...
public class Rectangle extends RectangularShape {
	...
	/**
	 * Uses a default {@link HighPerformanceRectangleVertexBufferObject} in
	 * {@link DrawType#STATIC} with the {@link VertexBufferObjectAttribute}s:
	 * {@link Rectangle#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	...
	/**
	 * Uses a default {@link HighPerformanceRectangleVertexBufferObject} with
	...
	public Rectangle(final float pX, final float pY, final float pWidth, final float pHeight,
		...
		this(pX, pY, pWidth, pHeight, new HighPerformanceRectangleVertexBufferObject(pVertexBufferObjectManager, Rectangle.RECTANGLE_SIZE,
				pDrawType, true, Rectangle.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
