...
public class HighPerformanceMeshVertexBufferObject extends HighPerformanceVertexBufferObject implements IMeshVertexBufferObject {
	...
	public HighPerformanceMeshVertexBufferObject(final VertexBufferObjectManager pVertexBufferObjectManager, final float[] pBufferData,
			final int pVertexCount, final DrawType pDrawType, final boolean pAutoDispose,
	...
	public void onUpdateVertices(final Mesh pMesh) {
		/*
		 * Since the buffer data is managed from the caller, we just mark the
		 * buffer data as dirty.
		 */
