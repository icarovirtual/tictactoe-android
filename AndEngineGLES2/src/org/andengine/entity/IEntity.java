...
public interface IEntity extends IDrawHandler, IUpdateHandler, IDisposable {
	 ...
	 * @return all children (recursively!) that match the supplied
	 *         {@link IEntityMatcher}.
	 */
	...
	/**
	 * @param pEntityMatcher
	 * @return the first child (recursively!) that matches the supplied
	 *         {@link IEntityMatcher} or <code>null</code> if none matches..
	 */
	 ...
	 * @param pEntityMatcher
	 * @param pResult
	 *            the {@link List} to put the result into.
	 * @return all children (recursively!) that match the supplied
	 *         {@link IEntityMatcher}.
	 */
	 ...
	 *             when the supplied {@link IEntityMatcher} matched an
	 *             {@link IEntity} that was not of the requested subtype.
	 */
	 ...
	 *             {@link IEntity} that was not of the requested subtype.
	 */
	public <L extends List<S>, S extends IEntity> L queryForSubclass(final IEntityMatcher pEntityMatcher, final L pResult)
			throws ClassCastException;
	 ...
	 * {@link Scene} or the {@link Engine} itself, because otherwise it may
	 ...
	 * 
	 * @param pCamera
	 *            the currently active camera to perform culling checks against.
	 * @return <code>true</code> when this object is visible by the
	 *         {@link Camera}, <code>false</code> otherwise.
	 */
