...
public class QuadraticBezierCurveMoveModifier extends DurationEntityModifier {
	 ...
	 * @param pY2
	 *            y coordinate of the ontrol point.
	 * @param pX3
	 *            x coordinate of the end point.
	 * @param pY3
	 *            y coordinate of the end point.
	 */
	public QuadraticBezierCurveMoveModifier(final float pDuration, final float pX1, final float pY1, final float pX2, final float pY2,
	 ...
	 */
	public QuadraticBezierCurveMoveModifier(final float pDuration, final float pX1, final float pY1, final float pX2, final float pY2,
			final float pX3, final float pY3, final IEaseFunction pEaseFunction) {
	 ...
	 */
	public QuadraticBezierCurveMoveModifier(final float pDuration, final float pX1, final float pY1, final float pX2, final float pY2,
			final float pX3, final float pY3, final IEntityModifierListener pEntityModifierListener) {
	 ...
	 */
	public QuadraticBezierCurveMoveModifier(final float pDuration, final float pX1, final float pY1, final float pX2, final float pY2,
			final float pX3, final float pY3, final IEaseFunction pEaseFunction, final IEntityModifierListener pEntityModifierListener) {
	...
	public QuadraticBezierCurveMoveModifier deepCopy() {
		return new QuadraticBezierCurveMoveModifier(this.mDuration, this.mX1, this.mY1, this.mX2, this.mY2, this.mX3, this.mY3,
				this.mEaseFunction);
	}
