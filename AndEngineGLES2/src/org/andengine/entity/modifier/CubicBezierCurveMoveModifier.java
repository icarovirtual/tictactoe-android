...
public class CubicBezierCurveMoveModifier extends DurationEntityModifier {
	 ...
	 */
	public CubicBezierCurveMoveModifier(final float pDuration, final float pX1, final float pY1, final float pX2, final float pY2,
			final float pX3, final float pY3, final float pX4, final float pY4) {
	 ...
	 */
	public CubicBezierCurveMoveModifier(final float pDuration, final float pX1, final float pY1, final float pX2, final float pY2,
			final float pX3, final float pY3, final float pX4, final float pY4, final IEaseFunction pEaseFunction) {
	 ...
	 */
	public CubicBezierCurveMoveModifier(final float pDuration, final float pX1, final float pY1, final float pX2, final float pY2,
			final float pX3, final float pY3, final float pX4, final float pY4, final IEntityModifierListener pEntityModifierListener) {
	...
	public CubicBezierCurveMoveModifier deepCopy() {
		return new CubicBezierCurveMoveModifier(this.mDuration, this.mX1, this.mY1, this.mX2, this.mY2, this.mX3, this.mY3, this.mX4,
				this.mY4, this.mEaseFunction);
	}
	...
	protected void onManagedUpdate(final float pSecondsElapsed, final IEntity pEntity) {
		...
		/*
		 * Formula: ((1-t)^3 * P1) + (3*(t)*(1-t)^2 * P2) + (3*(tt)*(1-t) * P3)
		 * + (ttt * P4)
		 */
