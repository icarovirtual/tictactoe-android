...
public class LoopEntityModifier extends LoopModifier<IEntity> implements IEntityModifier {
	...
	public LoopEntityModifier(final IEntityModifier pEntityModifier, final int pLoopCount,
			final ILoopEntityModifierListener pLoopModifierListener) {
	...
	public LoopEntityModifier(final IEntityModifierListener pEntityModifierListener, final int pLoopCount,
			final ILoopEntityModifierListener pLoopModifierListener, final IEntityModifier pEntityModifier) {
