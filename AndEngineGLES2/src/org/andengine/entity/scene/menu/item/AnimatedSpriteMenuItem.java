...
public class AnimatedSpriteMenuItem extends AnimatedSprite implements IMenuItem {
	...
	public AnimatedSpriteMenuItem(final int pID, final ITiledTextureRegion pTiledTextureRegion,
	...
	public AnimatedSpriteMenuItem(final int pID, final float pWidth, final float pHeight, final ITiledTextureRegion pTiledTextureRegion,
			final VertexBufferObjectManager pVertexBufferObjectManager) {
