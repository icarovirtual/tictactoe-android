...
public class AnimatedSprite extends TiledSprite {
	...
	public AnimatedSprite(final float pX, final float pY, final float pWidth, final float pHeight,
	...
	public AnimatedSprite(final float pX, final float pY, final float pWidth, final float pHeight,
		...
		super(pX, pY, pWidth, pHeight, pTiledTextureRegion, pTiledSpriteVertexBufferObject, PositionColorTextureCoordinatesShaderProgram
				.getInstance());
	}
