 ...
 */
public class HighPerformanceTiledSpriteVertexBufferObject extends HighPerformanceSpriteVertexBufferObject implements
	...
	public HighPerformanceTiledSpriteVertexBufferObject(final VertexBufferObjectManager pVertexBufferObjectManager, final int pCapacity,
	...
	public void onUpdateVertices(final TiledSprite pTiledSprite) {
		...
		final float x = 0;
		final float y = 0;
		final float x2 = pTiledSprite.getWidth(); // TODO Optimize with field
													// access?
		final float y2 = pTiledSprite.getHeight(); // TODO Optimize with field
													// access?
	...
	public void onUpdateTextureCoordinates(final TiledSprite pTiledSprite) {
		...
		for (int i = 0; i < tileCount; i++) {
			...
			if (pTiledSprite.isFlippedVertical()) { // TODO Optimize with field
													// access?
				if (pTiledSprite.isFlippedHorizontal()) { // TODO Optimize with
															// field access?
