...
public class AnimationPackTiledTextureRegion extends TiledTextureRegion {
	...
	public AnimationPackTiledTextureRegion(final String pAnimationName, final long[] pFrameDurations, final int pLoopCount,
			final ITexture pTexture, final ITextureRegion... pTextureRegions) {
