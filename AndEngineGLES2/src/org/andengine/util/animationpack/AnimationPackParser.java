...
public class AnimationPackParser extends DefaultHandler {
	...
	public void startElement(final String pUri, final String pLocalName, final String pQualifiedName, final Attributes pAttributes)
		...
		if (pLocalName.equals(AnimationPackParser.TAG_ANIMATIONPACK)) {
			...
			final String texturePackName = SAXUtils
					.getAttributeOrThrow(pAttributes, AnimationPackParser.TAG_TEXTUREPACK_ATTRIBUTE_FILENAME);
			...
			this.mCurrentAnimationLoopCount = SAXUtils.getIntAttribute(pAttributes, AnimationPackParser.TAG_ANIMATION_ATTRIBUTE_LOOPCOUNT,
					IAnimationData.LOOP_CONTINUOUS);
			...
			final String textureRegionName = SAXUtils.getAttributeOrThrow(pAttributes,
					AnimationPackParser.TAG_ANIMATIONFRAME_ATTRIBUTE_TEXTUREREGION);
			final TexturePackTextureRegion texturePackTextureRegion = this.mTexturePackLibrary
					.getTexturePackTextureRegion(textureRegionName);
	...
	public void endElement(final String pUri, final String pLocalName, final String pQualifiedName) throws SAXException {
		if (pLocalName.equals(AnimationPackParser.TAG_ANIMATIONPACK)) {
			...
			final AnimationPackTiledTextureRegion animationPackTiledTextureRegion = new AnimationPackTiledTextureRegion(
					this.mCurrentAnimationName, frameDurations, this.mCurrentAnimationLoopCount, textureRegions[0].getTexture(),
					textureRegions);
