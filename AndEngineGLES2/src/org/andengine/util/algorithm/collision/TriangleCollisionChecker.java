...
public class TriangleCollisionChecker {
	...
	public static boolean checkContains(final float pX1, final float pY1, final float pX2, final float pY2, final float pX3,
			final float pY3, final float pX, final float pY) {
	...
	public static boolean checkContains(final float pX1, final float pY1, final float pX2, final float pY2, final float pX3,
			final float pY3, final Transformation pTransformation, final float pX, final float pY) {
